...
extension CMUXCLI {
    ...
    private func buildMemoryPayload(
        ...
        do {
            ...
            throw CLIError(message: String(localized: "cli.memory.error.diagnosticsUnsupported", defaultValue: "cmux memory requires a running UniConnect build that supports memory diagnostics"))
        }
    }
