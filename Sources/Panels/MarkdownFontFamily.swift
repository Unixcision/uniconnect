...
enum MarkdownFontFamily {
    /// UserDefaults / uniconnect.json key (`markdown.fontFamily`).
    ...
    /// collapse to spaces so a malformed uniconnect.json value cannot produce invalid
    /// multiline CSS.
    ...
    /// UserDefaults / uniconnect.json and falling back to the System default.
