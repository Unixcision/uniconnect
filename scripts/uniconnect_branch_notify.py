...
def queue_event(source, archive, thread, *, runner=subprocess.run):
    ...
    message = (
        ...
        "Lee ese archivo y el progress.md compartido. Si este ID ya se atendió en esta "
        ...
        "Unixcision/uniconnect; usa --repo Unixcision/uniconnect en gh. Lee los progress.md "
        "de las referencias que cambiaron, sus diferencias y la CI antes de coordinarte. "
        ...
        "la rama de desarrollo vigente según progress.md y el remoto, con árbol limpio, "
