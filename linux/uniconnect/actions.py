...
ACTIONS = (
    ...
    Action("relaunch_window", "Relanzar IA de esta ventana…"),
    Action("relaunch_workspace", "Relanzar IA de este espacio…"),
    ...
    Action("window_up", "Subir ventana en la lista"),
    Action("window_down", "Bajar ventana en la lista"),
    Action("window_first", "Mover ventana al principio de su grupo"),
