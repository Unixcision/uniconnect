...
public enum CmuxSidebarExtensionPoint {
    ...
    /// per build tag (e.g. `com.unixcision.uniconnect.debug.my-tag.cmux.sidebar`) so that concurrent debug
    ...
    /// committed to source.
    public static let baseIdentifier = "com.unixcision.uniconnect.sidebar"
