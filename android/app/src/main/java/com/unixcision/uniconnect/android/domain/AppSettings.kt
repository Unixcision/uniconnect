 ...
 * - Parameter transcription: whether dictated audio is turned into text by a machine, which is
 *   better at it, or by the phone itself.
 * - Parameter transcriptionMachine: the identifier of the machine that transcribes when
 *   [TranscriptionMode.MACHINE] was chosen; the name is not stored, so renaming a machine keeps
 *   the choice.
 */
data class AppSettings(
    ...
    val transcriptionMachine: String? = null,
) {
